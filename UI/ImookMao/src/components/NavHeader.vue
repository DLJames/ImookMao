<template>
  <header class="header">
    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <span class="navbar-link" v-text="nickName" vf="nickName"></span>
    ...
    <div class="md-modal modal-msg md-modal-transition" :class="{'md-show': loginModalFlag}">
      <div class="md-modal-inner">
        <div class="md-top">
          ...
          <button class="md-close" @click="hideLoginDialog">Close</button>
        </div>
    ...
    <div class="md-overlay" v-if="loginModalFlag" @click="hideLoginDialog"></div>
  </header>
</template>
