<template>
  <div>
    ...
    <div class="container">
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          <div class="addr-list">
            <ul>
              <li v-for="(item, index) in addressListFilter" :key="item.addressId" :class="{'check': checkIndex === index}" @click="changeSel(index, item.addressId)">
                <dl>
                  <dt>{{item.userName}}</dt>
                ...
                <div class="addr-opration addr-del">
                  <a href="javascript:;" class="addr-del-btn" @click="showDelConfirm(item.addressId)">
          ...
          <div class="shipping-addr-more">
            <a class="addr-more-btn up-down-btn" :class="{'open': this.limit > 3}" href="javascript:;" @click="showMoreAddress" v-show="showMore">
              more
              <i class="i-up-down">
    ...
    <modal :mdShow="isMdShow" @closeModal="closeDelConfirm">
      <p slot="message">
        你真的要删除此地址么？
      </p>
      <p slot="btnGroup">
        <a href="javascript:;" class="btn btn--m" @click="delAddress">确定</a>
        <a href="javascript:;" class="btn btn--m" @click="closeDelConfirm">取消</a>
      </p>
    </modal>
